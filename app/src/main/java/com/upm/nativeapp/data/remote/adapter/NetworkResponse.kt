package com.upm.nativeapp.data.remote.adapter
...
sealed class NetworkResponse<out S : Any, out E : Any> {
     ...
     * Network error
     */
    data class NetworkError(val code: Int, val error: IOException) :
        NetworkResponse<Nothing, Nothing>()

    /**
     * For example, json parsing error
     */
    data class UnknownError(val code: Int, val error: Throwable?) :
        NetworkResponse<Nothing, Nothing>()
}